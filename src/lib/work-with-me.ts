...
export const Q: Question[] = [{k:'sit',q:'Where are you right now?',o:[
 ...
 ['built','We built something and launched it','And it’s quieter than we expected.'],
 ['growing','It works and it’s growing','And design is now the bottleneck, or about to be.'],
...
{k:'want',q:'What do you actually want from me?',o:[
 ['decide','One decision settled, properly','There’s a specific fork and we keep going round it.'],
...
embedded:{lab:'My recommendation',name:'Embedded work',meta:'Ongoing · one client at a time',kind:'embedded',
 why:'<p>You do not need one answer. You need somebody in the room while the answers keep changing, who is not already invested in the plan you have.</p>'+
     '<p>Design work where design is genuinely the bottleneck, but that’s never the whole job. Most of it’s deciding what not to build, and <strong>writing the decision down so your team still has it after I leave.</strong></p>',
 ...
 note:'One condition: it only works if I can disagree with you in front of your team. If that’s a problem, take the review instead.'},

capacity:{lab:'Straight answer',name:'You may need a hire, not me',meta:'But there’s a version that works',kind:'capacity',
 why:'<p>“It works and design is the bottleneck” usually means you need <strong>capacity</strong>, and capacity is a hiring problem. I would be an expensive and temporary answer to it.</p>'+
     '<p>What I can genuinely help with is the part before the hire: what the role actually needs to be, what to screen for, and which of your current problems are design problems rather than decision problems. That’s often one session, and it can save a bad hire — the most expensive mistake on this page.</p>',
...
export const SPECIFIC: Record<string, string[][]> = {session:[['s1','What is the decision?','textarea','State it as a question with two or more answers. “Do we build X or Y before the launch?”'],
 ...
 critique:[['s1','What should I look at?','textarea','Links, a staging URL, a Figma file, a TestFlight build. Whatever exists.'],
           ...
           ['s3','Anything you already suspect is weak?','textarea','I’ll look anyway, but knowing where you’re uneasy is useful.']],
 ...
 capacity:[['s1','What is falling over right now?','textarea','What is not getting done, and what that’s costing you.'],
 ...
 nope:[['s1','What kind of person are you looking for?','textarea','Seniority, focus, contract or permanent. I’ll point you at somebody if I can.']],
...
export const BLUNT_HTML = `<div class="b"><span class="x"><svg><use href="#xm"/></svg></span><div>
      ...
      <div class="b"><span class="x"><svg><use href="#xm"/></svg></span><div>
        ...
        <p>I’m not being modest — I would be a worse hire than the person you can get full-time. Cheaper, faster, closer to the product. Paying me to push pixels is paying a premium for friction.</p></div></div>
      <div class="b"><span class="x"><svg><use href="#xm"/></svg></span><div>
...
export const FAQ_HTML = `<details><summary>How does this actually work?<span class="pm" aria-hidden="true">+</span></summary><div class="ans">
    ...
    <details><summary>Do you really need to talk to our users?<span class="pm" aria-hidden="true">+</span></summary><div class="ans">
      ...
      <p>Without them I’m reviewing your product against my own assumptions. A guess delivered with confidence is more dangerous than no answer, because you will act on it.</p></div></details>
