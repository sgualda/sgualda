...
export const INDEX_FAQ_HTML = `<details><summary>Are these really free?<span class="pm" aria-hidden="true">+</span></summary><div class="ans">
    ...
    <details><summary>Why is nobody using my product?<span class="pm" aria-hidden="true">+</span></summary><div class="ans">
      ...
      <p>The fixes point in opposite directions. More traffic only helps the first one, a better product only helps the last one — which is why guessing is expensive. <a class="tl" href="tools/why-is-nobody-using-your-product.html">The first check</a> tells you which one you’re in.</p></div></details>
