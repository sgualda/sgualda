...
summary: 'Illustrated serialised fiction with the reading habit built in. Demand is validated. Now finding out what it’s worth.'
order: 0
migrated: true
...
That’s not a content problem, it’s a **returning problem**, and it’s the one worth solving. People rarely abandon a story because it got bad. They abandon it because eleven days passed, they lost the thread, and picking it up again now costs more than starting something new.

So the product is not organised around discovery. It’s organised around **resumption**.
...
Organic traffic arrives without us paying for any of it. People sign up. People come back and read. On the evidence available the thing works: there’s demand, and the habit loop does what it was built to do.

That’s further than most side projects get. It’s also the most comfortable place to stall, which is why I’m writing this bit down.

## The question I have not answered

**Will any of them pay, and how much.**

I do not know, and it’s the only question that matters now. Usage is not willingness to pay — I’ve written [an entire check about this exact mistake](/tools/can-you-charge-for-your-product-yet/) and I’m currently sitting inside it.

The signal I’m waiting for is the one I tell everyone else to wait for: **somebody asking what it costs before I bring it up.** Until that happens, any price I pick is a guess wearing the clothes of a decision.
