---
title: 'MVP vs prototype: the distinction that cost me four months'
seoTitle: 'MVP vs prototype: what an MVP actually is'
description: 'An MVP is not a small product, it is an experiment. I learned the difference by spending four months building the wrong one. What each is for, and how to pick.'
...
faqs:
  ...
  - q: 'How small is too small for an MVP?'
    a: 'It is too small when it can no longer answer the question you built it for. That is the only test that matters. A version that skips onboarding, settings and half the features is fine if the question is whether people want the core thing at all.'
  - q: 'How do you know if your MVP worked?'
    a: 'Somebody used it a second time, on their own, without you in the room. Sign-ups, compliments and demo enthusiasm are all reactions to you rather than to the product. Repeat use is the only one of those that survives you leaving the room.'
---
...
![A sketch of a minimum viable product: a landing page, a waiting list, and a question mark where the product should be](../../assets/essays/Image-showing-MVP-concept-for-business-growth.jpg)
